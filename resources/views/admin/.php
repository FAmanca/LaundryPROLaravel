        ...
        <div class="flex flex-col lg:flex-row gap-4">
            ...
            <div class="flex-1">
                <div class="relative">
                    ...
                    <input type="text" id="search-transaction" placeholder="Cari kode transaksi atau nama pelanggan..."
            ...
            <tbody class="divide-y divide-gray-200">
                ...
                <tr class="transaction-row">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap">
                        <div class="flex items-center gap-3">
                            <div
                                ...
                                strtoupper(substr(explode(' ', $transaction->customer->name)[1] ?? '', 0, 1)) }}
                            </div>
                            <div>
                                <div class="text-sm font-semibold text-gray-900">{{ $transaction->customer->name }}
                                </div>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap">
                        ...
                        @endphp
                        <span
                            class="{{ $badge['class'] }} inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-semibold text-white shadow-sm">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap">
                        ...
                        $laundry = $laundryBadge[$transaction->laundry_status] ?? $laundryBadge['process'];
                        @endphp
                        <span
                            class="{{ $laundry['class'] }} inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-semibold text-white shadow-sm">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap">
                        <div class="text-sm font-bold text-gray-900">Rp
                            {{ formatRupiahSingkat($transaction->total) }}</div>
                    </td>
                ...
                <tr>
                    <td colspan="9" class="px-6 py-16 text-center">
                        <div class="flex flex-col items-center justify-center">
                            ...
                            <p class="text-sm text-gray-500">Belum ada transaksi yang tercatat</p>
                        </div>
                    </td>
                </tr>
                @endforelse
                ...
                <div class="space-y-5">
                    ...
                    <div>
                        ...
                        <select name="payment_status" required
                            ...
                            <option value="Partial" {{ $transaction->payment_status == 'Partial' ? 'selected' : '' }}>DP
                                (Sebagian)
                            </option>
                    ...
                    <div>
                        ...
                        <select name="laundry_status" required
                            class="input-field w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all">
                            <option value="Pending" {{ $transaction->laundry_status == 'Pending' ? 'selected' : ''
                                }}>Masuk</option>
                            <option value="Process" {{ $transaction->laundry_status == 'Process' ? 'selected' : ''
                                }}>Proses</option>
                            <option value="Completed" {{ $transaction->laundry_status == 'Completed' ? 'selected' : ''
                                }}>Siap Diambil
                            </option>
                            <option value="Picked Up" {{ $transaction->laundry_status == 'Picked Up' ? 'selected' : ''
                                }}>Selesai
                            </option>
                        </select>
                    </div>
